...
> Este arquivo fica na raiz do repositório `viralspy-v2/` e é carregado automaticamente pelo Codex em todas as sessões neste diretório. Define regras que valem SEMPRE, sem precisar repetir em cada prompt.

---

## 🎯 Autonomia máxima do Codex
